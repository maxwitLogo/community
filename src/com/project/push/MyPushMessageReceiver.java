...
import com.project.activity.TopActivity;
import com.project.app.Global;
import com.project.utils.PreferenceUtils;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		if (channelId != null) {
			...
			PreferenceUtils.setPrefString(context, "channelId", channelId);
		} else {
			Global.channelId = PreferenceUtils.getPrefString(context,
					"channelId", "");
		}
		if (userId != null) {
			Global.userId = userId;
			PreferenceUtils.setPrefString(context, "userId", userId);
		} else {
			Global.userId = PreferenceUtils
					.getPrefString(context, "userId", "");
		}
	}
	...
	public void onNotificationClicked(Context context, String title,
		...
		if (isRun(context)) {
			updateContent(context, notifyString, TopActivity.class);// 如果程序已经打开跳转到这个页面
		} else {
			// 需改
		}
	}
	...
	private void updateContent(Context context, String content, Class cls) {
